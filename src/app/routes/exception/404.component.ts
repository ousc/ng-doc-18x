...
@Component({
  ...
  template: `
    ...
    <div class="flex card flex-column align-items-center justify-content-center gap-5 sm:p-8 h-screen">
      ...
      <div
        class="font-bold text-900 text-center text-6xl border-top-1 surface-border pt-5">{{ 'PAGE_NOT_FOUND' | translate }}
      </div>
      <p-button [label]="'GO_TO_HOME' | translate" routerLink="/"></p-button>
    </div>
  `,
  standalone: true,
  styles: [
